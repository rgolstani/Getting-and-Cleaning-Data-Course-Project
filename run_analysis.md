...
First, we need to create a "data" dicrectory for our files. I've set de working directory as the ".". If you want to change it, just put the wanted directory into the `<setwd>` function.
...
At the end of the day, this is what we wanted. The final tidy dataset with the measurement's average per measure, activity and subject exported the the result.txt file.
